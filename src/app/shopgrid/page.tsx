...
const Shopgrid: React.FC = () => {
  const products = [
    ...
    { name: "image5", price: "$450", image: "/images/grid5.png" },
    { name: "Elegant Sofa", price: "$500", image: "/images/grid6.png" },
    { name: "Table Lamp", price: "$100", image: "/images/grid7.png" },
    { name: "Leather Sofa", price: "$700", image: "/images/grid8.png" },
    { name: "Modern Chair", price: "$450", image: "/images/grid9.png" },
    { name: "Elegant Sofa", price: "$500", image: "/images/grid10.png" },
    { name: "Table Lamp", price: "$100", image: "/images/grid11.png" },
    { name: "Leather Sofa", price: "$700", image: "/images/grid12.png" },
    // Repeat products as needed for demo purposes
  ];
        ...
        >
          {products.map((product, index) => (
            ...
            >
              ...
              />
              <h3 className="absolute bottom-3 left-4 text-md font-semibold text-gray-800 group-hover:text-purple-600 transition-all duration-300">
                {product.name}
              </h3>
              <div className="absolute bottom-3 right-4 text-sm text-gray-600 group-hover:text-purple-600 transition-all duration-300">
