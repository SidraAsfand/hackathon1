...
const BlogPage = () => {
  return (
    <div className="min-h-screen bg-white">
      <header className=" p-5 bg-purple-50 shadow ">
      ...
      <main className="container mx-auto max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 p-6 ">
        {/* Blog Section */}
        <section className="md:col-span-3">
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <img src="/images/b1.png" alt="Blog" className="w-full" />
            <div className="p-4">
        ...
        <section className="md:col-span-3">
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <img src="/images/b2.png" alt="Blog" className="w-full" />
            <div className="p-4">
              <div className="flex justify-between items-center text-xs text-gray-500 mb-2">
                <span className="flex items-center gap-1">
                  <i className="fa fa-pen"></i> Surf Aviation
        ...
        <section className="md:col-span-3">
          <article className="bg-white shadow rounded-lg overflow-hidden">
            <img src="/images/b3.png" alt="Blog" className="w-full" />
            <div className="p-4">
              <div className="flex justify-between items-center text-xs text-gray-500 mb-2">
                <span className="flex items-center gap-1">
                  <i className="fa fa-pen"></i> Surf Aviation
